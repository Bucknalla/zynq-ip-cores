...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.present_0 \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../ipstatic/axis_dwidth_converter_0/hdl" \
       +incdir+"../../../../crypto_wrapper.srcs/sources_1/ip/present_0_3/sources_1/ip/axis_dwidth_converter_0/hdl" \
       +incdir+"../../../../crypto_wrapper.srcs/sources_1/ip/present_0_3/sources_1/ip/axis_dwidth_converter_1/hdl"
}
