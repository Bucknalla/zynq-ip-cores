...
#
# Generated by export_simulation on Mon Jun 03 16:25:44 BST 2019
#
################################################################################
...
'-reset_run' switch to the './present_0.sh' script.

./present_0.sh -reset_run
...
./present_0.sh -noclean_files

For more information on the script, please type './present_0.sh -help'.
