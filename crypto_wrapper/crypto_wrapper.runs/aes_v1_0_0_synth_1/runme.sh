...
HD_PWD='/home/alex/GitHub/zynq-ip-cores/crypto_wrapper/crypto_wrapper.runs/aes_v1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_v1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_v1_0_0.tcl
