...
HD_PWD='/home/alex/GitHub/zynq-ip-cores/crypto_wrapper/crypto_wrapper.runs/present_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log present_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source present_0.tcl
